...
public class MemberController {
	...
	private void updateMember2() {
		...
		switch (sel) {
		case 1: updateField = "mem_pass"; break;
		case 2: updateField = "mem_name"; break;
		case 3: updateField = "mem_tel"; break;
		case 4: updateField = "mem_addr"; break;
		default:
			System.out.println("번호를 잘못 입력하였습니다.");
			break;
		}
		sc.nextLine(); //버퍼비우기
		System.out.println("수정할 "+updateField+" >> ");
		...
		}else System.out.println("upadate작업 실패");
